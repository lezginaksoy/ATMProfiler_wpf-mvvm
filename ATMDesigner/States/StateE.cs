...
namespace ATMDesigner.UI.States
{
    ...
    public class StateE : StateBase
    {
        public StateE(ViewModelDesignerCanvas Canvas)
            : base(Canvas)
        {
            SetDefaultData();
        }
        ...
        public class BufferLocationConverter : Xceed.Wpf.Toolkit.PropertyGrid.Attributes.IItemsSource
        {
            public Xceed.Wpf.Toolkit.PropertyGrid.Attributes.ItemCollection GetValues()
            {
                ...
                strings.Add(000,"1st Byte");
                strings.Add(001,"2nd Byte");
                strings.Add(002,"3rd Byte");
                strings.Add(003, "4th Byte");
                strings.Add(004,"5th Byte");
                strings.Add(005,"6th Byte");
                strings.Add(006,"7th Byte");
                strings.Add(007,"8th Byte");
        ...
        [Browsable(true)]
        [Category("State Parameters"), PropertyOrder(8), DescriptionAttribute("Buffer Location")]      
        [Xceed.Wpf.Toolkit.PropertyGrid.Attributes.ItemsSource(typeof(BufferLocationConverter))]
        ...
        public override Object StateChanged(string SelectedProperty, string newValue, Object ClassInstance, PropertyGrid SelectedPgrid)
        {
            ...
            StateE Selectedstate = new StateE();
            StateE Dynamicstate = new StateE();

            Selectedstate = (StateE)SelectedPgrid.SelectedObject;
            Dynamicstate = (StateE)ClassInstance;
            ...
            Dynamicstate._bufferLocation = Selectedstate.BufferLocation;
            Dynamicstate._cancelNextState = Selectedstate.CancelNextState;
            Dynamicstate._fdkANextState = Selectedstate.FDK_A_NextState;
            Dynamicstate._fdkBNextState = Selectedstate.FDK_B_NextState;
            Dynamicstate._fdkCNextState = Selectedstate.FDK_C_NextState;
            Dynamicstate._fdkDNextState = Selectedstate.FDK_D_NextState;
        ...
        {
            StateE State = new StateE();
            State = (StateE)SelectedPgrid.SelectedObject;
            ...
            sql = string.Format(sql, Guid, Status, DateTime.Now.ToString("yyyyMMddHHmmss"), State.StateNumber, State.StateDescription,
                ...
                State.FDK_A_NextState, State.FDK_B_NextState, State.FDK_C_NextState, State.FDK_D_NextState, State.BufferLocation,
         ...
         {
             StateType = "E";
             StateDescription = "Four FDK Selection Function State";
             _screen = "000";
         ...
         public override object FillStatesFromDB(object[] processRow, ArrayList StateList)
         {
             ...
             state._bufferLocation = processRow[15].ToString();
